...
(function (Game) {
    var Model = (function () {
        ...
        Model.prototype.generateItems = function () {
            ...
            this.Categories =
                [
                    ["Operon", "Promoter", "Operator", "Repressor protein", "Structural protein", "Inducer", "Robustness", "Ruggedness", "Negative Control", "Positive Control", "Bioprocess", "Hydrophobicity", "Affinity", "Solubility", "Biosensor", "Transducer", "Data Processor", "Bio-receptor", "Cell transplantation", "Tissue engineering", "Regenerative medicine", "Autologous", "Allogenic", "Xenogenic", "Syngeneic", "Stem cells", "Cellulosic biomass", "Lignin", "Biomimicry", "Hydrolysis", "Fermentation", "Transesterification", "Esterification", "Transfection", "Transformation", "Transcription", "qo2 (specific oxygen consumption rate)", "kLa  (volumetric mass transfer coefficient)", "Rennet", "Biological Oxygen Demand (BOD)", "ISO 9000", "Quality Assurance", "Quality Control", "Preclinical trial", "Phase 1 clinical trial", "Phase 2 clinical trial", "Phase 3 clinical trial"],
...
(function (Game) {
    var GameView = (function () {
        ...
        GameView.prototype.drawMenuTextHorizontal = function () {
            ...
            this.context.fillText("< ", -140 * this.width / 375, 65 * this.height / 667);
        ...
        GameView.prototype.drawMenuTextVertical = function () {
            ...
            this.context.textAlign = 'left';
            this.context.fillStyle = 'blue';
            this.context.fillText("< ", 30 * this.width / 375, 60 * this.height / 667);
        };
        ...
        GameView.prototype.clearT = function () {
            clearTimeout(this.bouncingAnimation);
            clearTimeout(this.slideLeftAnimation);
    ...
    var GameController = (function () {
        ...
        GameController.prototype.startGameOne = function () {
            ...
            window.ondeviceorientation = function (event) {
                ...
                if (self.gamma < 60 && mostRecentState > 60) {
                    mostRecentTimeItWasBeingHeldSideways = new Date().getTime();
                }
                /*
                if(self.gamma > 90){
                ...
                if (((self.gamma <= 45 && self.gamma > 0 && mostRecentState > 45) || (self.gamma > -45 && self.gamma < 0 && mostRecentState < -45))) {
                    if (Math.abs(self.beta) > 100) {
                ...
                else if (self.gamma > 45 || self.gamma <= -45) {
    ...
    var CategoriesView = (function () {
        ...
        CategoriesView.prototype.renderCategories = function (startingHeight, boolCategories) {
            ...
            for (var i = 0; i != this.categories.length; ++i) {
                ...
                this.context.globalAlpha = 1;
                if (boolCategories[i]) {
                    this.drawText(rectX, rectY, width, height, this.categories[i][0], "white");
                }
                else {
                    this.context.globalAlpha = .5;
                    this.drawText(rectX, rectY, width, height, this.categories[i][0], "red");
                }
