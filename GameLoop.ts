...
module Game{
	export class GameLoop{
		...
		switchToHelpState(){
			...
			var newView = new HelpView(this.resources,this.context,this.width,this.height,this.currentGame);
			this.view = newView;
			this.view.render(this.currentGame);
			
			var newController = new HelpController(this,this.canvas,this.width,this.height,this.model,newView, this.currentGame);
			this.controller = newController;
			this.controller.takeInput();
